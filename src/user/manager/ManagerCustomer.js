...
function createData(id, username, email, name, tel) {
    return { id, username, email, name, tel };
}
...
userJson.forEach((userObj, index) => {
    ...
    rows.push(createData(userObj.id, userObj.username, userObj.email, fullName, userObj.tel));
});
...
const EnhancedTableToolbar = (props) => {
    ...
    return (
        ...
        >
            ...
            <TextField id="filled-basic" label="Search" handleSearch={handleSearch}  variant="filled" />
        </Toolbar>
    );
};
                                            ...
                                            <TableRow
                                                ...
                                                <TableCell padding="checkbox">
                                                    <Checkbox
                                                        ...
                                                        inputProps={{ 'aria-labelledby': labelId }} onClick={(event) => handleClick(event, row.id)} />
                                                </TableCell>
